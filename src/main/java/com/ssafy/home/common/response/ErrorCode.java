...
public enum ErrorCode {
	...
	INVALID_TOKEN(HttpStatus.BAD_REQUEST, "4008", "토큰이 유효하지 않습니다."),
	EXPIRED_TOKEN(HttpStatus.BAD_REQUEST, "4009", "토큰이 만료됐습니다."),
	USER_NOT_FOUND(HttpStatus.NOT_FOUND, "4010", "존재하지 않는 사용자입니다."),
	NO_TOKEN(HttpStatus.BAD_REQUEST, "4011", "토큰이 존재하지 않습니다."),
